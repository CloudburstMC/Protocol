...
public class CraftingData {
    ...
    private final List<ItemDescriptorWithCount> inputs;
    ...
    public CraftingData(CraftingDataType type, String recipeId, int width, int height, int inputId, int inputDamage, List<ItemDescriptorWithCount> inputs,
    ...
    public CraftingData(CraftingDataType type, int width, int height, int inputId, int inputDamage, List<ItemDescriptorWithCount> inputs,
