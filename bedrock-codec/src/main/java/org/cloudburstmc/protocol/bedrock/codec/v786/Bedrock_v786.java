...
public class Bedrock_v786 extends Bedrock_v776 {
    ...
    public static final BedrockCodec CODEC = Bedrock_v776.CODEC.toBuilder()
            ...
            .registerPacket(UpdateClientOptions::new, UpdateClientOptionsSerializer_v786.INSTANCE, 323, PacketRecipient.SERVER)
            .registerPacket(PlayerVideoCapturePacket::new, PlayerVideoCaptureSerializer_v786.INSTANCE, 324, PacketRecipient.SERVER)
            ...
            .deregisterPacket(LevelSoundEvent1Packet.class)
            .deregisterPacket(LevelSoundEvent2Packet.class)
            .build();
}