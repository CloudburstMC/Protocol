...
public class Bedrock_v407 extends Bedrock_v390 {
    ...
    protected static final TypeMap<ContainerSlotType> CONTAINER_SLOT_TYPES = TypeMap.builder(ContainerSlotType.class)
            ...
            .insert(7, ContainerSlotType.CONTAINER)
            ...
            .insert(22, ContainerSlotType.ENCHANTING_LAPIS)
            .insert(23, ContainerSlotType.FURNACE_FUEL)
            .insert(24, ContainerSlotType.FURNACE_INGREDIENT)
            .insert(25, ContainerSlotType.FURNACE_OUTPUT)
            .insert(26, ContainerSlotType.HORSE_EQUIP)
            .insert(27, ContainerSlotType.HOTBAR)
            .insert(28, ContainerSlotType.INVENTORY)
            .insert(29, ContainerSlotType.SHULKER)
            .insert(30, ContainerSlotType.TRADE_INGREDIENT1)
            .insert(31, ContainerSlotType.TRADE_INGREDIENT2)
            .insert(32, ContainerSlotType.TRADE_RESULT)
            .insert(33, ContainerSlotType.OFFHAND)
            .insert(34, ContainerSlotType.COMPCREATE_INPUT)
            .insert(35, ContainerSlotType.COMPCREATE_OUTPUT)
            .insert(36, ContainerSlotType.ELEMCONSTRUCT_OUTPUT)
            .insert(37, ContainerSlotType.MATREDUCE_INPUT)
            .insert(38, ContainerSlotType.MATREDUCE_OUTPUT)
            .insert(39, ContainerSlotType.LABTABLE_INPUT)
            ...
            .insert(46, ContainerSlotType.TRADE2_INGREDIENT1)
            .insert(47, ContainerSlotType.TRADE2_INGREDIENT2)
            ...
            .insert(59, ContainerSlotType.CREATIVE_OUTPUT)
            .build();
