...
public class BedrockCodecHelper_v729 extends BedrockCodecHelper_v712 {
    ...
    public BedrockCodecHelper_v729(EntityDataTypeMap entityData, TypeMap<Class<?>> gameRulesTypes, TypeMap<ItemStackRequestActionType> stackRequestActionTypes, TypeMap<ContainerSlotType> containerSlotTypes, TypeMap<Ability> abilities, TypeMap<TextProcessingEventOrigin> textProcessingEventOrigins) {
    ...
    public FullContainerName readFullContainerName(ByteBuf buffer) {
        return new FullContainerName(
                ...
                this.readOptional(buffer, null, ByteBuf::readIntLE)
        );
    }
}