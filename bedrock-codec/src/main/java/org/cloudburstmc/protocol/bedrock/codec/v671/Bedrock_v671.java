...
public class Bedrock_v671 extends Bedrock_v662 {
    ...
    protected static final TypeMap<SoundEvent> SOUND_EVENTS = Bedrock_v662.SOUND_EVENTS
            .toBuilder()
            .replace(511, SoundEvent.CRACK_WOLF)
            .insert(512, SoundEvent.BREAK_WOLF)
            .insert(513, SoundEvent.REPAIR_WOLF)
            .insert(514, SoundEvent.SMASH_AIR)
            .insert(515, SoundEvent.SMASH_GROUND)
            .insert(520, SoundEvent.HEAVY_SMASH_GROUND)
