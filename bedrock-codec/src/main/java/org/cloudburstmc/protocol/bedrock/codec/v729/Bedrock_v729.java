...
public class Bedrock_v729 extends Bedrock_v712 {
    ...
    protected static final TypeMap<SoundEvent> SOUND_EVENTS = Bedrock_v712.SOUND_EVENTS
            .toBuilder()
            .replace(531, SoundEvent.IMITATE_ENDERMITE) // TODO check
            .insert(533, SoundEvent.BUNDLE_INSERT_FAIL)
            .insert(534, SoundEvent.IMITATE_DROWNED) // TODO check
            .insert(535, SoundEvent.UNDEFINED)
            .build();
    ...
    public static final BedrockCodec CODEC = Bedrock_v712.CODEC.toBuilder()
            ...
            .registerPacket(CameraAimAssistPacket::new, CameraAimAssistSerializer_v729.INSTANCE, 316, PacketRecipient.CLIENT) // TODO check if recipient is correct
