...
public class Bedrock_v662 extends Bedrock_v649 {
    ...
    protected static final TypeMap<SoundEvent> SOUND_EVENTS = Bedrock_v649.SOUND_EVENTS
            ...
            .replace(501, SoundEvent.VAULT_CLOSE_SHUTTER)
            .replace(502, SoundEvent.VAULT_EJECT_ITEM)
            .replace(503, SoundEvent.VAULT_INSERT_ITEM)
            .replace(504, SoundEvent.VAULT_INSERT_ITEM_FAIL)
            .replace(505, SoundEvent.VAULT_AMBIENT)
            .replace(506, SoundEvent.VAULT_ACTIVATE)
            .replace(507, SoundEvent.VAULT_DEACTIVATE)
            .replace(508, SoundEvent.HURT_REDUCED)
            .replace(509, SoundEvent.WIND_CHARGE_BURST)
            .replace(511, SoundEvent.UNDEFINED)
            .build();
