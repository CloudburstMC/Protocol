...
public class Bedrock_v662 extends Bedrock_v649 {
    ...
    protected static final TypeMap<SoundEvent> SOUND_EVENTS = Bedrock_v649.SOUND_EVENTS
            .toBuilder()
            .replace(500, SoundEvent.OPEN_SHUTTER)
            .insert(501, SoundEvent.CLOSE_SHUTTER)
            .insert(502, SoundEvent.EJECT_ITEM)
            .insert(503, SoundEvent.INSERT_ITEM)
            .insert(504, SoundEvent.INSERT_ITEM_FAIL)
