...
public class BedrockPacketHelper_v5000425 extends BedrockPacketHelper_v419 {
    public static final BedrockPacketHelper_v5000425 INSTANCE = new BedrockPacketHelper_v5000425();
    ...
    protected void registerStackActionRequestTypes() {
        ...
        this.stackRequestActionTypes.put(12, CRAFT_RECIPE_OPTIONAL); // new for v5000425
    ...
    public ItemStackRequest readItemStackRequest(ByteBuf buffer, BedrockSession session) {
        ...
        List<String> filteredStrings = new ArrayList<>(); // new for v5000425
    ...
    public void writeItemStackRequest(ByteBuf buffer, BedrockSession session, ItemStackRequest request) {
        ...
        this.writeArray(buffer, request.getFilterStrings(), this::writeString); // new for v5000425
    }
