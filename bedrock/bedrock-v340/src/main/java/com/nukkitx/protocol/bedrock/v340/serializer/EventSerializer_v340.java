...
public class EventSerializer_v340 implements PacketSerializer<EventPacket> {
    public static final EventSerializer_v340 INSTANCE = new EventSerializer_v340();
    private static final InternalLogger log = InternalLoggerFactory.getInstance(EventSerializer_v340.class);
