...
public class CommandRequestSerializer_v340 implements PacketSerializer<CommandRequestPacket> {
    public static final CommandRequestSerializer_v340 INSTANCE = new CommandRequestSerializer_v340();
