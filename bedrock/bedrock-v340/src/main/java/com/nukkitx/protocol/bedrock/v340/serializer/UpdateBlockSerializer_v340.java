...
public class UpdateBlockSerializer_v340 implements PacketSerializer<UpdateBlockPacket> {
    public static final UpdateBlockSerializer_v340 INSTANCE = new UpdateBlockSerializer_v340();
