...
public class CommandOutputSerializer_v340 implements PacketSerializer<CommandOutputPacket> {
    public static final CommandOutputSerializer_v340 INSTANCE = new CommandOutputSerializer_v340();
