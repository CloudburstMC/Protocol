...
public class SubClientLoginSerializer_v340 implements PacketSerializer<SubClientLoginPacket> {
    public static final SubClientLoginSerializer_v340 INSTANCE = new SubClientLoginSerializer_v340();
