...
public class BlockEventSerializer_v340 implements PacketSerializer<BlockEventPacket> {
    public static final BlockEventSerializer_v340 INSTANCE = new BlockEventSerializer_v340();
