...
public class MobEffectSerializer_v340 implements PacketSerializer<MobEffectPacket> {
    public static final MobEffectSerializer_v340 INSTANCE = new MobEffectSerializer_v340();
