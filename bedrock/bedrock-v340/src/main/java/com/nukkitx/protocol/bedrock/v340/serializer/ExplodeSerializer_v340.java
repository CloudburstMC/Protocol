...
public class ExplodeSerializer_v340 implements PacketSerializer<ExplodePacket> {
    public static final ExplodeSerializer_v340 INSTANCE = new ExplodeSerializer_v340();
