...
public class DisconnectSerializer_v340 implements PacketSerializer<DisconnectPacket> {
    public static final DisconnectSerializer_v340 INSTANCE = new DisconnectSerializer_v340();
