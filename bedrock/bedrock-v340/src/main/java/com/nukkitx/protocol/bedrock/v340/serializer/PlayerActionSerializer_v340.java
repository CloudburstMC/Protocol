...
public class PlayerActionSerializer_v340 implements PacketSerializer<PlayerActionPacket> {
    public static final PlayerActionSerializer_v340 INSTANCE = new PlayerActionSerializer_v340();
