...
public class UpdateAttributesSerializer_v340 implements PacketSerializer<UpdateAttributesPacket> {
    public static final UpdateAttributesSerializer_v340 INSTANCE = new UpdateAttributesSerializer_v340();
