...
public class PacketHeaderSerializer_v340 implements PacketSerializer<PacketHeader> {
    public static final PacketHeaderSerializer_v340 INSTANCE = new PacketHeaderSerializer_v340();
