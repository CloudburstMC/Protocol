...
public class Bedrock_v340 {
    public static BedrockPacketCodec V340_CODEC = BedrockPacketCodec.builder()
            ...
            .registerPacket(AddHangingEntityPacket.class, AddHangingEntitySerializer_v340.INSTANCE, 16)
            ...
            .registerPacket(FullChunkDataPacket.class, FullChunkDataSerializer_v340.INSTANCE, 58)
