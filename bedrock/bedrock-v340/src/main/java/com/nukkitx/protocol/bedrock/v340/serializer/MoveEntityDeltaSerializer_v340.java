...
public class MoveEntityDeltaSerializer_v340 implements PacketSerializer<MoveEntityDeltaPacket> {
    public static final MoveEntityDeltaSerializer_v340 INSTANCE = new MoveEntityDeltaSerializer_v340();
