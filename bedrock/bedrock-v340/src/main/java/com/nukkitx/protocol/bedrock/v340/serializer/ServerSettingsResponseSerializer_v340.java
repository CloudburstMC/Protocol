...
public class ServerSettingsResponseSerializer_v340 implements PacketSerializer<ServerSettingsResponsePacket> {
    public static final ServerSettingsResponseSerializer_v340 INSTANCE = new ServerSettingsResponseSerializer_v340();
