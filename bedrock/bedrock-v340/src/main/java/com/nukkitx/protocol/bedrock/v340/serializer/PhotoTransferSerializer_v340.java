...
public class PhotoTransferSerializer_v340 implements PacketSerializer<PhotoTransferPacket> {
    public static final PhotoTransferSerializer_v340 INSTANCE = new PhotoTransferSerializer_v340();
