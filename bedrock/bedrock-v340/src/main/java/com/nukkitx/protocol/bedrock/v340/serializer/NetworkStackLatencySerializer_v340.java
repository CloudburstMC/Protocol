...
public class NetworkStackLatencySerializer_v340 implements PacketSerializer<NetworkStackLatencyPacket> {
    public static final NetworkStackLatencySerializer_v340 INSTANCE = new NetworkStackLatencySerializer_v340();
