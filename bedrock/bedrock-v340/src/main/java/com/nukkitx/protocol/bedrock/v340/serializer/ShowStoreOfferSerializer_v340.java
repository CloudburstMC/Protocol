...
public class ShowStoreOfferSerializer_v340 implements PacketSerializer<ShowStoreOfferPacket> {
    public static final ShowStoreOfferSerializer_v340 INSTANCE = new ShowStoreOfferSerializer_v340();
