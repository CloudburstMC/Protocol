...
public class AddEntitySerializer_v340 implements PacketSerializer<AddEntityPacket> {
    public static final AddEntitySerializer_v340 INSTANCE = new AddEntitySerializer_v340();
