...
public class ServerSettingsRequestSerializer_v340 implements PacketSerializer<ServerSettingsRequestPacket> {
    public static final ServerSettingsRequestSerializer_v340 INSTANCE = new ServerSettingsRequestSerializer_v340();
