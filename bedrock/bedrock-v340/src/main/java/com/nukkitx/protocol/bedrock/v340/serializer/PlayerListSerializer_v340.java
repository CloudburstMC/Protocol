...
public class PlayerListSerializer_v340 implements PacketSerializer<PlayerListPacket> {
    public static final PlayerListSerializer_v340 INSTANCE = new PlayerListSerializer_v340();
    ...
    public void deserialize(ByteBuf buffer, PlayerListPacket packet) {
        PlayerListPacket.Action action = Action.values()[buffer.readUnsignedByte()];
