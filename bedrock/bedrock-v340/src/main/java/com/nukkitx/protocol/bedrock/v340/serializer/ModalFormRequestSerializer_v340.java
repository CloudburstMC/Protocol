...
public class ModalFormRequestSerializer_v340 implements PacketSerializer<ModalFormRequestPacket> {
    public static final ModalFormRequestSerializer_v340 INSTANCE = new ModalFormRequestSerializer_v340();
