...
import static com.nukkitx.protocol.bedrock.v340.serializer.LevelSoundEvent1Serializer_v340.SOUNDS;

@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class LevelSoundEvent2Serializer_v340 implements PacketSerializer<LevelSoundEvent2Packet> {
    public static final LevelSoundEvent2Serializer_v340 INSTANCE = new LevelSoundEvent2Serializer_v340();
