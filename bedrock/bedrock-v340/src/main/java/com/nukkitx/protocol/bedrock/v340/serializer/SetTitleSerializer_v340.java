...
public class SetTitleSerializer_v340 implements PacketSerializer<SetTitlePacket> {
    public static final SetTitleSerializer_v340 INSTANCE = new SetTitleSerializer_v340();
