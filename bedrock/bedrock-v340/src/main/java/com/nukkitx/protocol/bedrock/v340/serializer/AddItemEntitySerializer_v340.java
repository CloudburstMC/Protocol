...
public class AddItemEntitySerializer_v340 implements PacketSerializer<AddItemEntityPacket> {
    public static final AddItemEntitySerializer_v340 INSTANCE = new AddItemEntitySerializer_v340();
