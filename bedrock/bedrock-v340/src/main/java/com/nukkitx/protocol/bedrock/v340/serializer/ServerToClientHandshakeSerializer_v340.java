...
public class ServerToClientHandshakeSerializer_v340 implements PacketSerializer<ServerToClientHandshakePacket> {
    public static final ServerToClientHandshakeSerializer_v340 INSTANCE = new ServerToClientHandshakeSerializer_v340();
