...
public class LabTableSerializer_v340 implements PacketSerializer<LabTablePacket> {
    public static final LabTableSerializer_v340 INSTANCE = new LabTableSerializer_v340();
