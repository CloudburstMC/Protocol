...
public class UpdateEquipSerializer_v340 implements PacketSerializer<UpdateEquipPacket> {
    public static final UpdateEquipSerializer_v340 INSTANCE = new UpdateEquipSerializer_v340();
