...
public class StopSoundSerializer_v340 implements PacketSerializer<StopSoundPacket> {
    public static final StopSoundSerializer_v340 INSTANCE = new StopSoundSerializer_v340();
