...
public class ContainerSetDataSerializer_v340 implements PacketSerializer<ContainerSetDataPacket> {
    public static final ContainerSetDataSerializer_v340 INSTANCE = new ContainerSetDataSerializer_v340();
