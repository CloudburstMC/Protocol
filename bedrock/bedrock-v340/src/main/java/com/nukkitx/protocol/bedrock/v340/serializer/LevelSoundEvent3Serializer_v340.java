...
import com.nukkitx.protocol.bedrock.packet.LevelSoundEvent3Packet;
...
public class LevelSoundEvent3Serializer_v340 implements PacketSerializer<LevelSoundEvent3Packet> {
    ...
    @Override
    public void serialize(ByteBuf buffer, LevelSoundEvent3Packet packet) {
    ...
    @Override
    public void deserialize(ByteBuf buffer, LevelSoundEvent3Packet packet) {
