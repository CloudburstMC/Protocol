...
public class LevelSoundEvent3Serializer_v340 implements PacketSerializer<LevelSoundEventPacket> {
    public static final LevelSoundEvent3Serializer_v340 INSTANCE = new LevelSoundEvent3Serializer_v340();
