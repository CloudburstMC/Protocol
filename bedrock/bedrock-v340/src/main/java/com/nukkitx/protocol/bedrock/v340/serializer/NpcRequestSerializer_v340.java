...
public class NpcRequestSerializer_v340 implements PacketSerializer<NpcRequestPacket> {
    public static final NpcRequestSerializer_v340 INSTANCE = new NpcRequestSerializer_v340();
