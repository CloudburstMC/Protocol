...
public class PurchaseReceiptSerializer_v340 implements PacketSerializer<PurchaseReceiptPacket> {
    public static final PurchaseReceiptSerializer_v340 INSTANCE = new PurchaseReceiptSerializer_v340();
