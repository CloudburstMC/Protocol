...
public class ShowProfileSerializer_v340 implements PacketSerializer<ShowProfilePacket> {
    public static final ShowProfileSerializer_v340 INSTANCE = new ShowProfileSerializer_v340();
