...
public class EntityFallSerializer_v340 implements PacketSerializer<EntityFallPacket> {
    public static final EntityFallSerializer_v340 INSTANCE = new EntityFallSerializer_v340();
