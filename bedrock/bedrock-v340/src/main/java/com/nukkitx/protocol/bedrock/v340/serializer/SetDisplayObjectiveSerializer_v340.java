...
public class SetDisplayObjectiveSerializer_v340 implements PacketSerializer<SetDisplayObjectivePacket> {
    public static final SetDisplayObjectiveSerializer_v340 INSTANCE = new SetDisplayObjectiveSerializer_v340();
