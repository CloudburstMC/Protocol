...
public class BedrockCodecHelper_v354 extends BedrockCodecHelper_v340 {

    public static final BedrockCodecHelper INSTANCE = new BedrockCodecHelper_v354();

    @Override
    protected void registerEntityData() {
        super.registerEntityData();

        this.addEntityData(102, EntityData.TRADE_XP);
    }
    ...
    protected void registerLevelEvents() {
        ...
        this.addLevelEvent(22 + 2000, LevelEvent.PARTICLE_KNOCKBACK_ROAR);
    }
}
