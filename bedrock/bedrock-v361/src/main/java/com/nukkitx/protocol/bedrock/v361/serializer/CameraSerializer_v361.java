...
public class CameraSerializer_v361 implements PacketSerializer<CameraPacket> {
    public static final CameraSerializer_v361 INSTANCE = new CameraSerializer_v361();
