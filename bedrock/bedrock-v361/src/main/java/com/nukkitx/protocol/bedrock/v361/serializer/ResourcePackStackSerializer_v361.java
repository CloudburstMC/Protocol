...
public class ResourcePackStackSerializer_v361 implements PacketSerializer<ResourcePackStackPacket> {
    public static final ResourcePackStackSerializer_v361 INSTANCE = new ResourcePackStackSerializer_v361();
