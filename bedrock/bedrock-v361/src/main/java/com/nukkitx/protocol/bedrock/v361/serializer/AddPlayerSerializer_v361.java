...
public class AddPlayerSerializer_v361 implements PacketSerializer<AddPlayerPacket> {
    public static final AddPlayerSerializer_v361 INSTANCE = new AddPlayerSerializer_v361();
    ...
    public void deserialize(ByteBuf buffer, AddPlayerPacket packet) {
        ...
        AdventureSettingsSerializer_v361.INSTANCE.deserialize(buffer, packet.getAdventureSettings());
