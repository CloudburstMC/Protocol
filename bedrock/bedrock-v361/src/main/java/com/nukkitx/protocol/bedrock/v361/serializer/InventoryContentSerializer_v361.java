...
public class InventoryContentSerializer_v361 implements PacketSerializer<InventoryContentPacket> {
    public static final InventoryContentSerializer_v361 INSTANCE = new InventoryContentSerializer_v361();
