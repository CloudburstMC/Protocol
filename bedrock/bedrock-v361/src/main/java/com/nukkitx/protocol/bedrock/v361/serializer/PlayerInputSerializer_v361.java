...
public class PlayerInputSerializer_v361 implements PacketSerializer<PlayerInputPacket> {
    public static final PlayerInputSerializer_v361 INSTANCE = new PlayerInputSerializer_v361();
