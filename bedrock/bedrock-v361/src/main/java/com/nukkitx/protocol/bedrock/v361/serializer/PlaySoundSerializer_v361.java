...
public class PlaySoundSerializer_v361 implements PacketSerializer<PlaySoundPacket> {
    public static final PlaySoundSerializer_v361 INSTANCE = new PlaySoundSerializer_v361();
