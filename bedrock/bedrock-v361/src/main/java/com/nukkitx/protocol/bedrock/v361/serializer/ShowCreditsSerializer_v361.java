...
public class ShowCreditsSerializer_v361 implements PacketSerializer<ShowCreditsPacket> {
    public static final ShowCreditsSerializer_v361 INSTANCE = new ShowCreditsSerializer_v361();
