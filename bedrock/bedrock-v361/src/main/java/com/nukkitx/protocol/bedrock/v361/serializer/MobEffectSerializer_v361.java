...
public class MobEffectSerializer_v361 implements PacketSerializer<MobEffectPacket> {
    public static final MobEffectSerializer_v361 INSTANCE = new MobEffectSerializer_v361();
