...
public class TakeItemEntitySerializer_v361 implements PacketSerializer<TakeItemEntityPacket> {
    public static final TakeItemEntitySerializer_v361 INSTANCE = new TakeItemEntitySerializer_v361();
