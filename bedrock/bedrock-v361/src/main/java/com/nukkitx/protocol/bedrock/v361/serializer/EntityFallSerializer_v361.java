...
public class EntityFallSerializer_v361 implements PacketSerializer<EntityFallPacket> {
    public static final EntityFallSerializer_v361 INSTANCE = new EntityFallSerializer_v361();
