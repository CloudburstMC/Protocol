...
public class SetScoreSerializer_v361 implements PacketSerializer<SetScorePacket> {
    public static final SetScoreSerializer_v361 INSTANCE = new SetScoreSerializer_v361();
