...
public class UpdateBlockSerializer_v361 implements PacketSerializer<UpdateBlockPacket> {
    public static final UpdateBlockSerializer_v361 INSTANCE = new UpdateBlockSerializer_v361();
