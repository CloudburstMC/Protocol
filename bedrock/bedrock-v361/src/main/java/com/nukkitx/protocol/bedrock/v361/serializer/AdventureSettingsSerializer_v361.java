...
public class AdventureSettingsSerializer_v361 implements PacketSerializer<AdventureSettingsPacket> {
    public static final AdventureSettingsSerializer_v361 INSTANCE = new AdventureSettingsSerializer_v361();
