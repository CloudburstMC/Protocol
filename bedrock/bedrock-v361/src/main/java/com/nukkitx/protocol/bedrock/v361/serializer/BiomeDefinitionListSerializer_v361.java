...
public class BiomeDefinitionListSerializer_v361 implements PacketSerializer<BiomeDefinitionListPacket> {
    public static final BiomeDefinitionListSerializer_v361 INSTANCE = new BiomeDefinitionListSerializer_v361();
