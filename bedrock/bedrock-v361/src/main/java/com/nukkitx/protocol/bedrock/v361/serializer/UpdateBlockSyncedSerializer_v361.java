...
public class UpdateBlockSyncedSerializer_v361 implements PacketSerializer<UpdateBlockSyncedPacket> {
    public static final UpdateBlockSyncedSerializer_v361 INSTANCE = new UpdateBlockSyncedSerializer_v361();
