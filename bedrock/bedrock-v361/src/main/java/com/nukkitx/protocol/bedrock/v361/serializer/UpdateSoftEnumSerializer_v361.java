...
public class UpdateSoftEnumSerializer_v361 implements PacketSerializer<UpdateSoftEnumPacket> {
    public static final UpdateSoftEnumSerializer_v361 INSTANCE = new UpdateSoftEnumSerializer_v361();
