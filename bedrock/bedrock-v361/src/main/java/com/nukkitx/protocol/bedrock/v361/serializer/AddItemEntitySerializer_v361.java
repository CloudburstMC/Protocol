...
public class AddItemEntitySerializer_v361 implements PacketSerializer<AddItemEntityPacket> {
    public static final AddItemEntitySerializer_v361 INSTANCE = new AddItemEntitySerializer_v361();
