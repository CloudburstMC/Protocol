...
public class LevelSoundEvent3Serializer_v361 implements PacketSerializer<LevelSoundEventPacket> {
    public static final LevelSoundEvent3Serializer_v361 INSTANCE = new LevelSoundEvent3Serializer_v361();
