...
public class PacketHeaderSerializer_v361 implements PacketSerializer<PacketHeader> {
    public static final PacketHeaderSerializer_v361 INSTANCE = new PacketHeaderSerializer_v361();
