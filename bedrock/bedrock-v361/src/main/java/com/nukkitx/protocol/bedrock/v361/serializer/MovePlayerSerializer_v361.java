...
public class MovePlayerSerializer_v361 implements PacketSerializer<MovePlayerPacket> {
    public static final MovePlayerSerializer_v361 INSTANCE = new MovePlayerSerializer_v361();
