...
public class SetTitleSerializer_v361 implements PacketSerializer<SetTitlePacket> {
    public static final SetTitleSerializer_v361 INSTANCE = new SetTitleSerializer_v361();
