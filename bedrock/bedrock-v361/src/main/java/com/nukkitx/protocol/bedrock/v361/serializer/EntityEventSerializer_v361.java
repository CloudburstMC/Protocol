...
public class EntityEventSerializer_v361 implements PacketSerializer<EntityEventPacket> {
    public static final EntityEventSerializer_v361 INSTANCE = new EntityEventSerializer_v361();
    private static final Int2ObjectBiMap<EntityEventType> events = new Int2ObjectBiMap<>();
    private static final InternalLogger log = InternalLoggerFactory.getInstance(EntityEventSerializer_v361.class);
