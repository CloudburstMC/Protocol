...
public class CraftingEventSerializer_v363 implements PacketSerializer<CraftingEventPacket> {
    public static final CraftingEventSerializer_v363 INSTANCE = new CraftingEventSerializer_v363();
