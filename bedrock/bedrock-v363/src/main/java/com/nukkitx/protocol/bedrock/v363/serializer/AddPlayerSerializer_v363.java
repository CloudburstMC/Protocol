...
public class AddPlayerSerializer_v363 implements PacketSerializer<AddPlayerPacket> {
    public static final AddPlayerSerializer_v363 INSTANCE = new AddPlayerSerializer_v363();
    ...
    public void serialize(ByteBuf buffer, AddPlayerPacket packet) {
        ...
        AdventureSettingsSerializer_v363.INSTANCE.serialize(buffer, packet.getAdventureSettings());
    ...
    public void deserialize(ByteBuf buffer, AddPlayerPacket packet) {
        ...
        AdventureSettingsSerializer_v363.INSTANCE.deserialize(buffer, packet.getAdventureSettings());
