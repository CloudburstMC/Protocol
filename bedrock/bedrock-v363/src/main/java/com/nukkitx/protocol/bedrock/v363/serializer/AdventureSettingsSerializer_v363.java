...
public class AdventureSettingsSerializer_v363 implements PacketSerializer<AdventureSettingsPacket> {
    public static final AdventureSettingsSerializer_v363 INSTANCE = new AdventureSettingsSerializer_v363();
