...
public class PacketHeaderSerializer_v363 implements PacketSerializer<PacketHeader> {
    public static final PacketHeaderSerializer_v363 INSTANCE = new PacketHeaderSerializer_v363();
