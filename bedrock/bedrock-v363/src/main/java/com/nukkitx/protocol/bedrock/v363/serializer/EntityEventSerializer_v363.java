...
public class EntityEventSerializer_v363 implements PacketSerializer<EntityEventPacket> {
    public static final EntityEventSerializer_v363 INSTANCE = new EntityEventSerializer_v363();
    private static final Int2ObjectBiMap<EntityEventType> events = new Int2ObjectBiMap<>();
    private static final InternalLogger log = InternalLoggerFactory.getInstance(EntityEventSerializer_v363.class);
