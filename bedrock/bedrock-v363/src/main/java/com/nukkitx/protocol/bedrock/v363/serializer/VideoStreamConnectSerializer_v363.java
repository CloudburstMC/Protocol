...
public class VideoStreamConnectSerializer_v363 implements PacketSerializer<VideoStreamConnectPacket> {
    public static final VideoStreamConnectSerializer_v363 INSTANCE = new VideoStreamConnectSerializer_v363();
