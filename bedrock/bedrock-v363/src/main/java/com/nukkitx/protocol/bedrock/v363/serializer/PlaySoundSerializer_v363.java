...
public class PlaySoundSerializer_v363 implements PacketSerializer<PlaySoundPacket> {
    public static final PlaySoundSerializer_v363 INSTANCE = new PlaySoundSerializer_v363();
