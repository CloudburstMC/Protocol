...
public class ServerSettingsResponseSerializer_v363 implements PacketSerializer<ServerSettingsResponsePacket> {
    public static final ServerSettingsResponseSerializer_v363 INSTANCE = new ServerSettingsResponseSerializer_v363();
