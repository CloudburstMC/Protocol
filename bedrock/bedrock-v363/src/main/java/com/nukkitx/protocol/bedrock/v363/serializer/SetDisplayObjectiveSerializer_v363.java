...
public class SetDisplayObjectiveSerializer_v363 implements PacketSerializer<SetDisplayObjectivePacket> {
    public static final SetDisplayObjectiveSerializer_v363 INSTANCE = new SetDisplayObjectiveSerializer_v363();
