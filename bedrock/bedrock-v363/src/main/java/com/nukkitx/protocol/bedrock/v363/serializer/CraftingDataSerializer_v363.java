...
public class CraftingDataSerializer_v363 implements PacketSerializer<CraftingDataPacket> {
    public static final CraftingDataSerializer_v363 INSTANCE = new CraftingDataSerializer_v363();

    private static final InternalLogger log = InternalLoggerFactory.getInstance(CraftingDataSerializer_v363.class);
