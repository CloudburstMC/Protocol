...
public class LevelSoundEvent3Serializer_v363 implements PacketSerializer<LevelSoundEventPacket> {
    public static final LevelSoundEvent3Serializer_v363 INSTANCE = new LevelSoundEvent3Serializer_v363();
