...
public class ExplodeSerializer_v363 implements PacketSerializer<ExplodePacket> {
    public static final ExplodeSerializer_v363 INSTANCE = new ExplodeSerializer_v363();
