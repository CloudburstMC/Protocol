...
public class NpcRequestSerializer_v363 implements PacketSerializer<NpcRequestPacket> {
    public static final NpcRequestSerializer_v363 INSTANCE = new NpcRequestSerializer_v363();
