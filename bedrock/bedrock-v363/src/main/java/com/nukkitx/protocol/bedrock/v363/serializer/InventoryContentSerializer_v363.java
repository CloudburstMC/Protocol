...
public class InventoryContentSerializer_v363 implements PacketSerializer<InventoryContentPacket> {
    public static final InventoryContentSerializer_v363 INSTANCE = new InventoryContentSerializer_v363();
