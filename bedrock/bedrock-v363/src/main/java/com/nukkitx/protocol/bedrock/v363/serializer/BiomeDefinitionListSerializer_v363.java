...
public class BiomeDefinitionListSerializer_v363 implements PacketSerializer<BiomeDefinitionListPacket> {
    public static final BiomeDefinitionListSerializer_v363 INSTANCE = new BiomeDefinitionListSerializer_v363();
