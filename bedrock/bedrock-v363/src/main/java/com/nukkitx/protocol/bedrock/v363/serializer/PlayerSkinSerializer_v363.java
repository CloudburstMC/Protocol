...
public class PlayerSkinSerializer_v363 implements PacketSerializer<PlayerSkinPacket> {
    public static final PlayerSkinSerializer_v363 INSTANCE = new PlayerSkinSerializer_v363();
