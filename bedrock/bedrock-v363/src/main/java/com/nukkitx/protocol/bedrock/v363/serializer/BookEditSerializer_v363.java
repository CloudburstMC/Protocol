...
public class BookEditSerializer_v363 implements PacketSerializer<BookEditPacket> {
    public static final BookEditSerializer_v363 INSTANCE = new BookEditSerializer_v363();
