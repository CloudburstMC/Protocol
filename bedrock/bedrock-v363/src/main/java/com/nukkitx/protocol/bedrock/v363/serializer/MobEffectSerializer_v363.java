...
public class MobEffectSerializer_v363 implements PacketSerializer<MobEffectPacket> {
    public static final MobEffectSerializer_v363 INSTANCE = new MobEffectSerializer_v363();
