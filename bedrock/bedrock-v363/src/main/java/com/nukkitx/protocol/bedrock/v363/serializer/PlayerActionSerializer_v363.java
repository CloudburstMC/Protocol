...
public class PlayerActionSerializer_v363 implements PacketSerializer<PlayerActionPacket> {
    public static final PlayerActionSerializer_v363 INSTANCE = new PlayerActionSerializer_v363();
