...
public class MoveEntityDeltaSerializer_v363 implements PacketSerializer<MoveEntityDeltaPacket> {
    public static final MoveEntityDeltaSerializer_v363 INSTANCE = new MoveEntityDeltaSerializer_v363();
