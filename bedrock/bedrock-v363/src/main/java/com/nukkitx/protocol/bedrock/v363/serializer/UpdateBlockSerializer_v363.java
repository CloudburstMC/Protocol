...
public class UpdateBlockSerializer_v363 implements PacketSerializer<UpdateBlockPacket> {
    public static final UpdateBlockSerializer_v363 INSTANCE = new UpdateBlockSerializer_v363();
