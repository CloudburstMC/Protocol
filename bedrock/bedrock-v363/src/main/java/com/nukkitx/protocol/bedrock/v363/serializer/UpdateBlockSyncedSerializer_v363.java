...
public class UpdateBlockSyncedSerializer_v363 implements PacketSerializer<UpdateBlockSyncedPacket> {
    public static final UpdateBlockSyncedSerializer_v363 INSTANCE = new UpdateBlockSyncedSerializer_v363();
