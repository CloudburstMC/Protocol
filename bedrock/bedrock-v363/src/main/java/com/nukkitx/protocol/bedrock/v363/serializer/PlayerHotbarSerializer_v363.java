...
public class PlayerHotbarSerializer_v363 implements PacketSerializer<PlayerHotbarPacket> {
    public static final PlayerHotbarSerializer_v363 INSTANCE = new PlayerHotbarSerializer_v363();
