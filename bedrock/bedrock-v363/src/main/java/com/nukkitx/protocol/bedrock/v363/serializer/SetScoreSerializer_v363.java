...
public class SetScoreSerializer_v363 implements PacketSerializer<SetScorePacket> {
    public static final SetScoreSerializer_v363 INSTANCE = new SetScoreSerializer_v363();
