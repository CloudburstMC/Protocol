...
public class AnimateSerializer_v363 implements PacketSerializer<AnimatePacket> {
    public static final AnimateSerializer_v363 INSTANCE = new AnimateSerializer_v363();
