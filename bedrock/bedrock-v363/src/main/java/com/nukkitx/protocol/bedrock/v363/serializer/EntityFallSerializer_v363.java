...
public class EntityFallSerializer_v363 implements PacketSerializer<EntityFallPacket> {
    public static final EntityFallSerializer_v363 INSTANCE = new EntityFallSerializer_v363();
