...
import com.nukkitx.protocol.education.v390.serializer.CraftingDataSerializer_v390;
import com.nukkitx.protocol.education.v390.serializer.StartGameSerializer_v390;
...
@UtilityClass
public class Education_v390 {
    public static BedrockPacketCodec V390_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(390)
            .raknetProtocolVersion(9)
            .minecraftVersion("1.14.31")
            .helper(EducationPacketHelper_v390.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v390.INSTANCE, 11)
            ...
            .registerPacket(CraftingDataPacket.class, CraftingDataSerializer_v390.INSTANCE, 52)
