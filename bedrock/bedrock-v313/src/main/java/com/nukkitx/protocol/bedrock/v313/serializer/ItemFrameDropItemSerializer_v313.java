...
public class ItemFrameDropItemSerializer_v313 implements PacketSerializer<ItemFrameDropItemPacket> {
    public static final ItemFrameDropItemSerializer_v313 INSTANCE = new ItemFrameDropItemSerializer_v313();
