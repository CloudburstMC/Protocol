...
public class BlockEventSerializer_v313 implements PacketSerializer<BlockEventPacket> {
    public static final BlockEventSerializer_v313 INSTANCE = new BlockEventSerializer_v313();
