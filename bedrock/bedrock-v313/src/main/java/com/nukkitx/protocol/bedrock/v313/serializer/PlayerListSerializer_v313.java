...
public class PlayerListSerializer_v313 implements PacketSerializer<PlayerListPacket> {
    public static final PlayerListSerializer_v313 INSTANCE = new PlayerListSerializer_v313();
