...
public class BlockPickRequestSerializer_v313 implements PacketSerializer<BlockPickRequestPacket> {
    public static final BlockPickRequestSerializer_v313 INSTANCE = new BlockPickRequestSerializer_v313();
