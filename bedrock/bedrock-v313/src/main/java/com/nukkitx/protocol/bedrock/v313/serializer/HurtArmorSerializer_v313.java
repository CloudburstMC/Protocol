...
public class HurtArmorSerializer_v313 implements PacketSerializer<HurtArmorPacket> {
    public static final HurtArmorSerializer_v313 INSTANCE = new HurtArmorSerializer_v313();
