...
public class UpdateBlockSyncedSerializer_v313 implements PacketSerializer<UpdateBlockSyncedPacket> {
    public static final UpdateBlockSyncedSerializer_v313 INSTANCE = new UpdateBlockSyncedSerializer_v313();
