...
public class AddItemEntitySerializer_v313 implements PacketSerializer<AddItemEntityPacket> {
    public static final AddItemEntitySerializer_v313 INSTANCE = new AddItemEntitySerializer_v313();
