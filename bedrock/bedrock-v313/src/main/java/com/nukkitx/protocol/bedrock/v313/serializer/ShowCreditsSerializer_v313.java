...
public class ShowCreditsSerializer_v313 implements PacketSerializer<ShowCreditsPacket> {
    public static final ShowCreditsSerializer_v313 INSTANCE = new ShowCreditsSerializer_v313();
