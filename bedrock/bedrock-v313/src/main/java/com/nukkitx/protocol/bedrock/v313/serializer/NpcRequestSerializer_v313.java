...
public class NpcRequestSerializer_v313 implements PacketSerializer<NpcRequestPacket> {
    public static final NpcRequestSerializer_v313 INSTANCE = new NpcRequestSerializer_v313();
