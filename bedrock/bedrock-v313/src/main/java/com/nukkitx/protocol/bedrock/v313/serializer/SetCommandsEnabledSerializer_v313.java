...
public class SetCommandsEnabledSerializer_v313 implements PacketSerializer<SetCommandsEnabledPacket> {
    public static final SetCommandsEnabledSerializer_v313 INSTANCE = new SetCommandsEnabledSerializer_v313();
