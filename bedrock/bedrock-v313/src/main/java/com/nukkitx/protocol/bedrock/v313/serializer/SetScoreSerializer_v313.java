...
public class SetScoreSerializer_v313 implements PacketSerializer<SetScorePacket> {
    public static final SetScoreSerializer_v313 INSTANCE = new SetScoreSerializer_v313();
