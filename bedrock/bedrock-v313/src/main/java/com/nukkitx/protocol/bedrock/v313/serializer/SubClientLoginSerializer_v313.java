...
public class SubClientLoginSerializer_v313 implements PacketSerializer<SubClientLoginPacket> {
    public static final SubClientLoginSerializer_v313 INSTANCE = new SubClientLoginSerializer_v313();
