...
public class MoveEntityDeltaSerializer_v313 implements PacketSerializer<MoveEntityDeltaPacket> {
    public static final MoveEntityDeltaSerializer_v313 INSTANCE = new MoveEntityDeltaSerializer_v313();
