...
public class AddPlayerSerializer_v313 implements PacketSerializer<AddPlayerPacket> {
    public static final AddPlayerSerializer_v313 INSTANCE = new AddPlayerSerializer_v313();
