...
public class CommandOutputSerializer_v313 implements PacketSerializer<CommandOutputPacket> {
    public static final CommandOutputSerializer_v313 INSTANCE = new CommandOutputSerializer_v313();
