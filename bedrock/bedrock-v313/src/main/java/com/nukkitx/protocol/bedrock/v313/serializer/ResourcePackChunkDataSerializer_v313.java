...
public class ResourcePackChunkDataSerializer_v313 implements PacketSerializer<ResourcePackChunkDataPacket> {
    public static final ResourcePackChunkDataSerializer_v313 INSTANCE = new ResourcePackChunkDataSerializer_v313();
