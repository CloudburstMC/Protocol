...
public class StopSoundSerializer_v313 implements PacketSerializer<StopSoundPacket> {
    public static final StopSoundSerializer_v313 INSTANCE = new StopSoundSerializer_v313();
