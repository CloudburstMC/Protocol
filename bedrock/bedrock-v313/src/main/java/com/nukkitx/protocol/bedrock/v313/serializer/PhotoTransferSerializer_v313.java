...
public class PhotoTransferSerializer_v313 implements PacketSerializer<PhotoTransferPacket> {
    public static final PhotoTransferSerializer_v313 INSTANCE = new PhotoTransferSerializer_v313();
