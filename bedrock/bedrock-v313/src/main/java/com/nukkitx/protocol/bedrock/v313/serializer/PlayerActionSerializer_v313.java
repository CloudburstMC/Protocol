...
public class PlayerActionSerializer_v313 implements PacketSerializer<PlayerActionPacket> {
    public static final PlayerActionSerializer_v313 INSTANCE = new PlayerActionSerializer_v313();
