...
public class UpdateBlockSerializer_v313 implements PacketSerializer<UpdateBlockPacket> {
    public static final UpdateBlockSerializer_v313 INSTANCE = new UpdateBlockSerializer_v313();
