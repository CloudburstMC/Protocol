...
public class AdventureSettingsSerializer_v313 implements PacketSerializer<AdventureSettingsPacket> {
    public static final AdventureSettingsSerializer_v313 INSTANCE = new AdventureSettingsSerializer_v313();
