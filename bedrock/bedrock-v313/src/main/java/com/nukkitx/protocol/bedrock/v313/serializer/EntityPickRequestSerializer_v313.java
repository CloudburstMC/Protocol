...
public class EntityPickRequestSerializer_v313 implements PacketSerializer<EntityPickRequestPacket> {
    public static final EntityPickRequestSerializer_v313 INSTANCE = new EntityPickRequestSerializer_v313();
