...
public class AddPaintingSerializer_v313 implements PacketSerializer<AddPaintingPacket> {
    public static final AddPaintingSerializer_v313 INSTANCE = new AddPaintingSerializer_v313();
