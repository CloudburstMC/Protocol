...
public class SetDefaultGameTypeSerializer_v313 implements PacketSerializer<SetDefaultGameTypePacket> {
    public static final SetDefaultGameTypeSerializer_v313 INSTANCE = new SetDefaultGameTypeSerializer_v313();
