package com.nukkitx.protocol.bedrock.v412;
...
import com.nukkitx.protocol.bedrock.v411.BedrockPacketHelper_v411;
import com.nukkitx.protocol.bedrock.v412.serializer.StartGameSerializer_v412;
import lombok.experimental.UtilityClass;

@UtilityClass
public class Bedrock_v412 {
    public static BedrockPacketCodec V412_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(412)
            .minecraftVersion("1.16.100.53")
            .helper(BedrockPacketHelper_v411.INSTANCE)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v412.INSTANCE, 11)
