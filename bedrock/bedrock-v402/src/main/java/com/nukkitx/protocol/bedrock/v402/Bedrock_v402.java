...
public class Bedrock_v402 {
    public static BedrockPacketCodec V392_CODEC = BedrockPacketCodec.builder()
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v402.INSTANCE, 11)
            ...
            .registerPacket(LevelSoundEvent1Packet.class, LevelSoundEvent1Serializer_v388.INSTANCE, 24)
            ...
            .registerPacket(LevelSoundEventPacket.class, LevelSoundEvent3Serializer_v388.INSTANCE, 123)
            ...
            .registerPacket(CreativeContentPacket.class, CreativeContentSerializer_v402.INSTANCE, 145)
            .registerPacket(PlayerEnchantOptionsPacket.class, PlayerEnchantOptionsSerializer_v402.INSTANCE, 146)
            .registerPacket(ItemStackRequestPacket.class, ItemStackRequestSerializer_v402.INSTANCE, 147)
            .registerPacket(ItemStackResponsePacket.class, ItemStackResponseSerializer_v402.INSTANCE, 148)
            .registerPacket(PlayerArmorDamagePacket.class, PlayerArmorDamageSerializer_v402.INSTANCE, 149)
            .registerPacket(CodeBuilderPacket.class, CodeBuilderSerializer_v402.INSTANCE, 150)
            .registerPacket(UpdatePlayerGameTypePacket.class, UpdatePlayerGameTypeSerializer_v402.INSTANCE, 151)
            .registerPacket(EmoteListPacket.class, EmoteListSerializer_v402.INSTANCE, 152)
            .build();
}
