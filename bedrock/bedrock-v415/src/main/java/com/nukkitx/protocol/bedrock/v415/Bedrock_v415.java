...
import com.nukkitx.protocol.bedrock.v415.serializer.*;
import lombok.experimental.UtilityClass;

@UtilityClass
public class Bedrock_v415 {
    public static BedrockPacketCodec V415_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(415)
            .minecraftVersion("1.16.100.56")
            .helper(BedrockPacketHelper_v415.INSTANCE)
            ...
            .registerPacket(ResourcePackStackPacket.class, ResourcePackStackSerializer_v415.INSTANCE, 7)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v415.INSTANCE, 11)
            ...
            .registerPacket(MovePlayerPacket.class, MovePlayerSerializer_v415.INSTANCE, 19)
            ...
            .registerPacket(UpdateAttributesPacket.class, UpdateAttributesSerializer_v415.INSTANCE, 29)
            ...
            .registerPacket(SetEntityDataPacket.class, SetEntityDataSerializer_v415.INSTANCE, 39)
            ...
            .registerPacket(ContainerClosePacket.class, ContainerCloseSerializer_v415.INSTANCE, 47)
            ...
            .registerPacket(MoveEntityDeltaPacket.class, MoveEntityDeltaSerializer_v415.INSTANCE, 111)
            ...
            .registerPacket(PlayerAuthInputPacket.class, PlayerAuthInputSerializer_v415.INSTANCE, 144)
            ...
            .registerPacket(SetEntityMotionPlusPacket.class, SetEntityMotionPlusSerializer_v415.INSTANCE, 157)
            .registerPacket(AnimateEntityPacket.class, AnimateEntitySerializer_v415.INSTANCE, 158)
            .registerPacket(CameraShakePacket.class, CameraShakeSerializer_v415.INSTANCE, 159)
            .registerPacket(PlayerFogPacket.class, PlayerFogSerializer_v415.INSTANCE, 160)
            .registerPacket(CorrectPlayerMovePredictionPacket.class, CorrectPlayerMovePredictionSerializer_v415.INSTANCE, 161)
            .build();
}
