...
public class RiderJumpSerializer_v354 implements PacketSerializer<RiderJumpPacket> {
    public static final RiderJumpSerializer_v354 INSTANCE = new RiderJumpSerializer_v354();
