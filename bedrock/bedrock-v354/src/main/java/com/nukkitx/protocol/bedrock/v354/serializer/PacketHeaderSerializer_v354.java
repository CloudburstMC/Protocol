...
public class PacketHeaderSerializer_v354 implements PacketSerializer<PacketHeader> {
    public static final PacketHeaderSerializer_v354 INSTANCE = new PacketHeaderSerializer_v354();
