...
public class UpdateAttributesSerializer_v354 implements PacketSerializer<UpdateAttributesPacket> {
    public static final UpdateAttributesSerializer_v354 INSTANCE = new UpdateAttributesSerializer_v354();
