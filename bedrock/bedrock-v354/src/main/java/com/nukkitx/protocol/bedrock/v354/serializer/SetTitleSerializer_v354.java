...
public class SetTitleSerializer_v354 implements PacketSerializer<SetTitlePacket> {
    public static final SetTitleSerializer_v354 INSTANCE = new SetTitleSerializer_v354();
