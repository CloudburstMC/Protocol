...
public class InventoryTransactionSerializer_v354 implements PacketSerializer<InventoryTransactionPacket> {
    public static final InventoryTransactionSerializer_v354 INSTANCE = new InventoryTransactionSerializer_v354();
