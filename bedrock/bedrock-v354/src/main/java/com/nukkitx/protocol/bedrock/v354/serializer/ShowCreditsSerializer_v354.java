...
public class ShowCreditsSerializer_v354 implements PacketSerializer<ShowCreditsPacket> {
    public static final ShowCreditsSerializer_v354 INSTANCE = new ShowCreditsSerializer_v354();
