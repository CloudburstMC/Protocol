...
public class NpcRequestSerializer_v354 implements PacketSerializer<NpcRequestPacket> {
    public static final NpcRequestSerializer_v354 INSTANCE = new NpcRequestSerializer_v354();
