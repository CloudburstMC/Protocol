...
public class MobEffectSerializer_v354 implements PacketSerializer<MobEffectPacket> {
    public static final MobEffectSerializer_v354 INSTANCE = new MobEffectSerializer_v354();
