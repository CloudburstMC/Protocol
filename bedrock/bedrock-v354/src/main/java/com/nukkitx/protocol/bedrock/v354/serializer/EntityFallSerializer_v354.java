...
public class EntityFallSerializer_v354 implements PacketSerializer<EntityFallPacket> {
    public static final EntityFallSerializer_v354 INSTANCE = new EntityFallSerializer_v354();
