...
public class AddPlayerSerializer_v354 implements PacketSerializer<AddPlayerPacket> {
    ...
    public void serialize(ByteBuf buffer, AddPlayerPacket packet) {
        ...
        AdventureSettingsSerializer_v354.INSTANCE.serialize(buffer, packet.getAdventureSettings());
    ...
    public void deserialize(ByteBuf buffer, AddPlayerPacket packet) {
        ...
        AdventureSettingsSerializer_v354.INSTANCE.deserialize(buffer, packet.getAdventureSettings());
