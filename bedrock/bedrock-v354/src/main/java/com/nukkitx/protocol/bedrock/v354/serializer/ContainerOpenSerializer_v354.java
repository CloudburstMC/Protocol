...
public class ContainerOpenSerializer_v354 implements PacketSerializer<ContainerOpenPacket> {
    public static final ContainerOpenSerializer_v354 INSTANCE = new ContainerOpenSerializer_v354();
