...
public class DisconnectSerializer_v354 implements PacketSerializer<DisconnectPacket> {
    public static final DisconnectSerializer_v354 INSTANCE = new DisconnectSerializer_v354();
