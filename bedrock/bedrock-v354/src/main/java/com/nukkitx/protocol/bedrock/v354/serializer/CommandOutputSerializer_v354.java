...
public class CommandOutputSerializer_v354 implements PacketSerializer<CommandOutputPacket> {
    public static final CommandOutputSerializer_v354 INSTANCE = new CommandOutputSerializer_v354();
