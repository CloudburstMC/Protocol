...
public class PlayerActionSerializer_v354 implements PacketSerializer<PlayerActionPacket> {
    public static final PlayerActionSerializer_v354 INSTANCE = new PlayerActionSerializer_v354();
