...
public class PlayerHotbarSerializer_v354 implements PacketSerializer<PlayerHotbarPacket> {
    public static final PlayerHotbarSerializer_v354 INSTANCE = new PlayerHotbarSerializer_v354();
