...
public class PlayStatusSerializer_v354 implements PacketSerializer<PlayStatusPacket> {
    public static final PlayStatusSerializer_v354 INSTANCE = new PlayStatusSerializer_v354();
