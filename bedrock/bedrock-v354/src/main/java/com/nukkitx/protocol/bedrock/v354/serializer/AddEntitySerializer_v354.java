...
public class AddEntitySerializer_v354 implements PacketSerializer<AddEntityPacket> {
    public static final AddEntitySerializer_v354 INSTANCE = new AddEntitySerializer_v354();
