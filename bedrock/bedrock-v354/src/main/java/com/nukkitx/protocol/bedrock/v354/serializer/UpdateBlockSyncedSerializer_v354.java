...
public class UpdateBlockSyncedSerializer_v354 implements PacketSerializer<UpdateBlockSyncedPacket> {
    public static final UpdateBlockSyncedSerializer_v354 INSTANCE = new UpdateBlockSyncedSerializer_v354();
