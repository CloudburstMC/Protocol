...
public class ExplodeSerializer_v354 implements PacketSerializer<ExplodePacket> {
    public static final ExplodeSerializer_v354 INSTANCE = new ExplodeSerializer_v354();
