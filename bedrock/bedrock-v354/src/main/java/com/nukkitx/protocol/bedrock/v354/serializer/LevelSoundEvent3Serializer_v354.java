...
import static com.nukkitx.protocol.bedrock.v354.serializer.LevelSoundEvent1Serializer_v354.SOUNDS;

@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class LevelSoundEvent3Serializer_v354 implements PacketSerializer<LevelSoundEventPacket> {
    public static final LevelSoundEvent3Serializer_v354 INSTANCE = new LevelSoundEvent3Serializer_v354();
