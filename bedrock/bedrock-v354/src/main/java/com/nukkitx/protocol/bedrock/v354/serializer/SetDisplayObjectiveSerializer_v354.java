...
public class SetDisplayObjectiveSerializer_v354 implements PacketSerializer<SetDisplayObjectivePacket> {
    public static final SetDisplayObjectiveSerializer_v354 INSTANCE = new SetDisplayObjectiveSerializer_v354();
