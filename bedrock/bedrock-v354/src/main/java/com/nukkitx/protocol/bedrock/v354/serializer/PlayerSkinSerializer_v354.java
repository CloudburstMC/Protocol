...
public class PlayerSkinSerializer_v354 implements PacketSerializer<PlayerSkinPacket> {
    public static final PlayerSkinSerializer_v354 INSTANCE = new PlayerSkinSerializer_v354();
