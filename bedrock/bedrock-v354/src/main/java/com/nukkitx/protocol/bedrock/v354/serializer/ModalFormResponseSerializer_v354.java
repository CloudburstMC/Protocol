...
public class ModalFormResponseSerializer_v354 implements PacketSerializer<ModalFormResponsePacket> {
    public static final ModalFormResponseSerializer_v354 INSTANCE = new ModalFormResponseSerializer_v354();
