...
public class Bedrock_v354 {
    public static BedrockPacketCodec V354_CODEC = BedrockPacketCodec.builder()
            ...
            .registerPacket(AddHangingEntityPacket.class, AddHangingEntitySerializer_v354.INSTANCE, 16)
            ...
            .registerPacket(LevelSoundEventPacket.class, LevelSoundEventSerializer_v354.INSTANCE, 24)
            ...
            .registerPacket(FullChunkDataPacket.class, FullChunkDataSerializer_v354.INSTANCE, 58)
            ...
            .registerPacket(LevelSoundEvent3Packet.class, LevelSoundEvent3Serializer_v354.INSTANCE, 123)
