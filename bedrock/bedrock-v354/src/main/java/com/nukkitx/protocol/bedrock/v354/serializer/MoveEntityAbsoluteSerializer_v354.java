...
public class MoveEntityAbsoluteSerializer_v354 implements PacketSerializer<MoveEntityAbsolutePacket> {
    public static final MoveEntityAbsoluteSerializer_v354 INSTANCE = new MoveEntityAbsoluteSerializer_v354();
