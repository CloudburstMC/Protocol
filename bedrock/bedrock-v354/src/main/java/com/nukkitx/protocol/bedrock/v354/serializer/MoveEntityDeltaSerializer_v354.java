...
public class MoveEntityDeltaSerializer_v354 implements PacketSerializer<MoveEntityDeltaPacket> {
    public static final MoveEntityDeltaSerializer_v354 INSTANCE = new MoveEntityDeltaSerializer_v354();
