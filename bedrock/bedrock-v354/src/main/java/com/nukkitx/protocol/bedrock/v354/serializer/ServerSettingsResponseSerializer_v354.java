...
public class ServerSettingsResponseSerializer_v354 implements PacketSerializer<ServerSettingsResponsePacket> {
    public static final ServerSettingsResponseSerializer_v354 INSTANCE = new ServerSettingsResponseSerializer_v354();
