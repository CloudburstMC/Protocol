...
public class SetSpawnPositionSerializer_v354 implements PacketSerializer<SetSpawnPositionPacket> {
    public static final SetSpawnPositionSerializer_v354 INSTANCE = new SetSpawnPositionSerializer_v354();
