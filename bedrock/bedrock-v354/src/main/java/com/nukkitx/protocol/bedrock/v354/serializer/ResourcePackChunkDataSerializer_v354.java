...
public class ResourcePackChunkDataSerializer_v354 implements PacketSerializer<ResourcePackChunkDataPacket> {
    public static final ResourcePackChunkDataSerializer_v354 INSTANCE = new ResourcePackChunkDataSerializer_v354();
