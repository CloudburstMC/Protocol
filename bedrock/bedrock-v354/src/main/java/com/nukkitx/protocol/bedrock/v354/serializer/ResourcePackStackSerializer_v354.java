...
public class ResourcePackStackSerializer_v354 implements PacketSerializer<ResourcePackStackPacket> {
    public static final ResourcePackStackSerializer_v354 INSTANCE = new ResourcePackStackSerializer_v354();
