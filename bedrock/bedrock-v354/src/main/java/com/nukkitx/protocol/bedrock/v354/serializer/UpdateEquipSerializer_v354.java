...
public class UpdateEquipSerializer_v354 implements PacketSerializer<UpdateEquipPacket> {
    public static final UpdateEquipSerializer_v354 INSTANCE = new UpdateEquipSerializer_v354();
