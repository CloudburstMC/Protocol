...
public class LevelSoundEventSerializer_v354 implements PacketSerializer<LevelSoundEventPacket> {
    public static final LevelSoundEventSerializer_v354 INSTANCE = new LevelSoundEventSerializer_v354();
