...
public class PlaySoundSerializer_v354 implements PacketSerializer<PlaySoundPacket> {
    public static final PlaySoundSerializer_v354 INSTANCE = new PlaySoundSerializer_v354();
