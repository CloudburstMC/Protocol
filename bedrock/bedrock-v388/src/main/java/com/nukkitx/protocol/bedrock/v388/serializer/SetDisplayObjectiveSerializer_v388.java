...
public class SetDisplayObjectiveSerializer_v388 implements PacketSerializer<SetDisplayObjectivePacket> {
    public static final SetDisplayObjectiveSerializer_v388 INSTANCE = new SetDisplayObjectiveSerializer_v388();
