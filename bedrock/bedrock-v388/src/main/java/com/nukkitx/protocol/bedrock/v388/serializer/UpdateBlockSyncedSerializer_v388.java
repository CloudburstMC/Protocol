...
public class UpdateBlockSyncedSerializer_v388 implements PacketSerializer<UpdateBlockSyncedPacket> {
    public static final UpdateBlockSyncedSerializer_v388 INSTANCE = new UpdateBlockSyncedSerializer_v388();
