...
public class CommandOutputSerializer_v388 implements PacketSerializer<CommandOutputPacket> {
    public static final CommandOutputSerializer_v388 INSTANCE = new CommandOutputSerializer_v388();
