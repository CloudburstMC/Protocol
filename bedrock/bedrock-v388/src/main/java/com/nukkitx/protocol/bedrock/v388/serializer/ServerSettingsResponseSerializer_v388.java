...
public class ServerSettingsResponseSerializer_v388 implements PacketSerializer<ServerSettingsResponsePacket> {
    public static final ServerSettingsResponseSerializer_v388 INSTANCE = new ServerSettingsResponseSerializer_v388();
