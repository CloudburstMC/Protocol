...
public class SimpleEventSerializer_v388 implements PacketSerializer<SimpleEventPacket> {
    public static final SimpleEventSerializer_v388 INSTANCE = new SimpleEventSerializer_v388();
