...
public class DisconnectSerializer_v388 implements PacketSerializer<DisconnectPacket> {
    public static final DisconnectSerializer_v388 INSTANCE = new DisconnectSerializer_v388();
