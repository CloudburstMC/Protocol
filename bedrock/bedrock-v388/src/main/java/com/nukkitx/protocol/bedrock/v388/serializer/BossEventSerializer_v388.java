...
public class BossEventSerializer_v388 implements PacketSerializer<BossEventPacket> {
    public static final BossEventSerializer_v388 INSTANCE = new BossEventSerializer_v388();
