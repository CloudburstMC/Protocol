...
public class MobEffectSerializer_v388 implements PacketSerializer<MobEffectPacket> {
    public static final MobEffectSerializer_v388 INSTANCE = new MobEffectSerializer_v388();
