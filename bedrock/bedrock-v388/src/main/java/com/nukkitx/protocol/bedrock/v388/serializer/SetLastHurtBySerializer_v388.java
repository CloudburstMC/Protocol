...
public class SetLastHurtBySerializer_v388 implements PacketSerializer<SetLastHurtByPacket> {
    public static final SetLastHurtBySerializer_v388 INSTANCE = new SetLastHurtBySerializer_v388();
