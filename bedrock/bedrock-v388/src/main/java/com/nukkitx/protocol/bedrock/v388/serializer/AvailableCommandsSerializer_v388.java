...
public class AvailableCommandsSerializer_v388 implements PacketSerializer<AvailableCommandsPacket> {
    private static final InternalLogger log = InternalLoggerFactory.getInstance(AvailableCommandsSerializer_v388.class);
