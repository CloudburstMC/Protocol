...
public class SubClientLoginSerializer_v388 implements PacketSerializer<SubClientLoginPacket> {
    public static final SubClientLoginSerializer_v388 INSTANCE = new SubClientLoginSerializer_v388();
