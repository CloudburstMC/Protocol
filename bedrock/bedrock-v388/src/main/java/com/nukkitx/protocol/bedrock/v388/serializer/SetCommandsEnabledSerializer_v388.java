...
public class SetCommandsEnabledSerializer_v388 implements PacketSerializer<SetCommandsEnabledPacket> {
    public static final SetCommandsEnabledSerializer_v388 INSTANCE = new SetCommandsEnabledSerializer_v388();
