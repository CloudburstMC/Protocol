...
public class SetScoreboardIdentitySerializer_v388 implements PacketSerializer<SetScoreboardIdentityPacket> {
    public static final SetScoreboardIdentitySerializer_v388 INSTANCE = new SetScoreboardIdentitySerializer_v388();
