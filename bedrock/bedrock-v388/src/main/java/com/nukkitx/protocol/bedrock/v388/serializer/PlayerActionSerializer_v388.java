...
public class PlayerActionSerializer_v388 implements PacketSerializer<PlayerActionPacket> {
    public static final PlayerActionSerializer_v388 INSTANCE = new PlayerActionSerializer_v388();
