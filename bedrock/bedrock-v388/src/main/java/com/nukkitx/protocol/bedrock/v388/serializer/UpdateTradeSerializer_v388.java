...
public class UpdateTradeSerializer_v388 implements PacketSerializer<UpdateTradePacket> {
    public static final UpdateTradeSerializer_v388 INSTANCE = new UpdateTradeSerializer_v388();
