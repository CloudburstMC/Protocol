...
public class SetEntityLinkSerializer_v388 implements PacketSerializer<SetEntityLinkPacket> {
    public static final SetEntityLinkSerializer_v388 INSTANCE = new SetEntityLinkSerializer_v388();
