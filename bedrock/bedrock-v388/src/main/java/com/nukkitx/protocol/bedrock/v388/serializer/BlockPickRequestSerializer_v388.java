...
public class BlockPickRequestSerializer_v388 implements PacketSerializer<BlockPickRequestPacket> {
    public static final BlockPickRequestSerializer_v388 INSTANCE = new BlockPickRequestSerializer_v388();
