...
public class AdventureSettingsSerializer_v388 implements PacketSerializer<AdventureSettingsPacket> {
    public static final AdventureSettingsSerializer_v388 INSTANCE = new AdventureSettingsSerializer_v388();
