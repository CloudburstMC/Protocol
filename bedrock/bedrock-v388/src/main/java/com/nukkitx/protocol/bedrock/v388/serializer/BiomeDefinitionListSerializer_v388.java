...
public class BiomeDefinitionListSerializer_v388 implements PacketSerializer<BiomeDefinitionListPacket> {
    public static final BiomeDefinitionListSerializer_v388 INSTANCE = new BiomeDefinitionListSerializer_v388();
