...
public class TransferSerializer_v388 implements PacketSerializer<TransferPacket> {
    public static final TransferSerializer_v388 INSTANCE = new TransferSerializer_v388();
