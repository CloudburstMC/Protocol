...
public class LevelEventSerializer_v388 implements PacketSerializer<LevelEventPacket> {
    ...
    static {
        ...
        events.put((28 | 0x4000), PARTICLE_DRIP_HONEY);
        events.put((29 | 0x4000), PARTICLE_FALLING_DUST);
        events.put((30 | 0x4000), PARTICLE_MOB_SPELL);
        events.put((31 | 0x4000), PARTICLE_MOB_SPELL_AMBIENT);
        events.put((32 | 0x4000), PARTICLE_MOB_SPELL_INSTANTANEOUS);
        events.put((33 | 0x4000), PARTICLE_NOTE_AND_DUST);

        events.put((34 | 0x4000), PARTICLE_SLIME);
        events.put((35 | 0x4000), PARTICLE_RAIN_SPLASH);
        events.put((36 | 0x4000), PARTICLE_VILLAGER_ANGRY);
        // 60 same as 36
        events.put((37 | 0x4000), PARTICLE_VILLAGER_HAPPY);
        events.put((38 | 0x4000), PARTICLE_ENCHANTMENT_TABLE);
        events.put((39 | 0x4000), PARTICLE_TRACKING_EMITTER);
        events.put((40 | 0x4000), PARTICLE_NOTE);
        events.put((41 | 0x4000), PARTICLE_WITCH_SPELL);
        events.put((42 | 0x4000), PARTICLE_CARROT);
        // 43 unknown
        events.put((44 | 0x4000), PARTICLE_END_ROD);
        // 59 same as 44
        events.put((45 | 0x4000), PARTICLE_RISING_DRAGONS_BREATH);
        events.put((46 | 0x4000), PARTICLE_SPIT);
        events.put((47 | 0x4000), PARTICLE_TOTEM);
        events.put((48 | 0x4000), PARTICLE_FOOD);
        events.put((49 | 0x4000), PARTICLE_FIREWORKS_STARTER);
        events.put((50 | 0x4000), PARTICLE_FIREWORKS_SPARK);
        events.put((51 | 0x4000), PARTICLE_FIREWORKS_OVERLAY);
        events.put((52 | 0x4000), PARTICLE_BALLOON_GAS);
        events.put((53 | 0x4000), PARTICLE_COLORED_FLAME);
        events.put((54 | 0x4000), PARTICLE_SPARKLER);
        events.put((55 | 0x4000), PARTICLE_CONDUIT);
        events.put((56 | 0x4000), PARTICLE_BUBBLE_COLUMN_UP);
        events.put((57 | 0x4000), PARTICLE_BUBBLE_COLUMN_DOWN);
        events.put((58 | 0x4000), PARTICLE_SNEEZE);

        events.put((61 | 0x4000), PARTICLE_LARGE_EXPLOSION);
        events.put((62 | 0x4000), PARTICLE_INK);
        events.put((63 | 0x4000), PARTICLE_FALLING_RED_DUST);
        events.put((64 | 0x4000), PARTICLE_CAMPFIRE_SMOKE);
        //65 same as 64
        events.put((66 | 0x4000), PARTICLE_FALLING_DRAGONS_BREATH);
        events.put((67 | 0x4000), PARTICLE_DRAGONS_BREATH);
    }
