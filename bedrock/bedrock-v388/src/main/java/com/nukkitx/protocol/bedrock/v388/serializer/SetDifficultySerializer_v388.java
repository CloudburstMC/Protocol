...
public class SetDifficultySerializer_v388 implements PacketSerializer<SetDifficultyPacket> {
    public static final SetDifficultySerializer_v388 INSTANCE = new SetDifficultySerializer_v388();
