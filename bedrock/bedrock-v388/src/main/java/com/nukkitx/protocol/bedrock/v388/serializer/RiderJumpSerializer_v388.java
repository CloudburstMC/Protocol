...
public class RiderJumpSerializer_v388 implements PacketSerializer<RiderJumpPacket> {
    public static final RiderJumpSerializer_v388 INSTANCE = new RiderJumpSerializer_v388();
