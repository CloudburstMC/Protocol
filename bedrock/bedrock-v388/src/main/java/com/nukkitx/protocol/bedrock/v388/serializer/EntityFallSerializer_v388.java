...
public class EntityFallSerializer_v388 implements PacketSerializer<EntityFallPacket> {
    public static final EntityFallSerializer_v388 INSTANCE = new EntityFallSerializer_v388();
