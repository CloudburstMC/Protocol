...
public class CameraSerializer_v388 implements PacketSerializer<CameraPacket> {
    public static final CameraSerializer_v388 INSTANCE = new CameraSerializer_v388();
