...
public class CraftingEventSerializer_v388 implements PacketSerializer<CraftingEventPacket> {
    public static final CraftingEventSerializer_v388 INSTANCE = new CraftingEventSerializer_v388();
