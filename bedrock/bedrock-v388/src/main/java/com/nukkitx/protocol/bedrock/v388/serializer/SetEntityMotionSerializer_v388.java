...
public class SetEntityMotionSerializer_v388 implements PacketSerializer<SetEntityMotionPacket> {
    public static final SetEntityMotionSerializer_v388 INSTANCE = new SetEntityMotionSerializer_v388();
