...
public final class BedrockUtils {
    ...
    static {
        ...
        METADATAS.put(86, BOAT_BUBBLE_TIME);
        METADATAS.put(87, AGENT_ID);


        METADATAS.put(90, EAT_COUNTER);
        METADATAS.put(91, FLAGS_2);


        METADATAS.put(94, AREA_EFFECT_CLOUD_DURATION);
        METADATAS.put(95, AREA_EFFECT_CLOUD_SPAWN_TIME);
        METADATAS.put(96, AREA_EFFECT_CLOUD_RADIUS_PER_TICK);
        METADATAS.put(97, AREA_EFFECT_CLOUD_RADIUS_CHANGE_ON_PICKUP);
        METADATAS.put(98, AREA_EFFECT_CLOUD_PICKUP_COUNT);
        METADATAS.put(99, INTERACTIVE_TAG);
        METADATAS.put(100, TRADE_TIER);
        ...
        METADATA_FLAGS.put(61, EntityFlag.TRANSITION_SITTING);
        METADATA_FLAGS.put(62, EntityFlag.EATING);
        METADATA_FLAGS.put(63, EntityFlag.LAYING_DOWN);
        METADATA_FLAGS.put(64, EntityFlag.SNEEZING);
        METADATA_FLAGS.put(65, EntityFlag.TRUSTING);
        METADATA_FLAGS.put(66, EntityFlag.ROLLING);
        METADATA_FLAGS.put(67, EntityFlag.SCARED);
        METADATA_FLAGS.put(68, EntityFlag.IN_SCAFFOLDING);
        METADATA_FLAGS.put(69, EntityFlag.OVER_SCAFFOLDING);
        ...
        METADATA_FLAGS.put(84, EntityFlag.DELAYED_ATTACKING);
        METADATA_FLAGS.put(85, EntityFlag.AVOIDING_MOBS);
    ...
    public static void writeRecipeIngredient(ByteBuf buffer, ItemData itemData) {
        Preconditions.checkNotNull(buffer, "buffer");
        Preconditions.checkNotNull(itemData, "itemData");
    ...
    public static void writeGameRule(ByteBuf buffer, GameRuleData<?> gameRule) {
        ...
        int type = GameRulesChangedSerializer_v388.RULE_TYPES.get(value.getClass());
    ...
    public static StructureEditorData readStructureEditorData(ByteBuf buffer) {
        ...
        String name = BedrockUtils.readString(buffer);
        String structureDataField = BedrockUtils.readString(buffer);
        boolean includePlayers = buffer.readBoolean();
        boolean showBoundingBox = buffer.readBoolean();
        int structureBlockType = VarInts.readInt(buffer);
        StructureSettings settings = BedrockUtils.readStructureSettings(buffer);

        return new StructureEditorData(name, structureDataField, includePlayers, showBoundingBox, structureBlockType,
                settings);
    }
    ...
    public static void writeStructureEditorData(ByteBuf buffer, StructureEditorData structureEditorData) {
        ...
        BedrockUtils.writeString(buffer, structureEditorData.getName());
        BedrockUtils.writeString(buffer, structureEditorData.getStructureDataField());
        buffer.writeBoolean(structureEditorData.isIncludePlayers());
        buffer.writeBoolean(structureEditorData.isShowBoundingBox());
        VarInts.writeInt(buffer, structureEditorData.getStructureBlockType());
        BedrockUtils.writeStructureSettings(buffer, structureEditorData.getStructureSettings());
    }
    ...
    public static void writeImageData(ByteBuf buffer, ImageData imageData) {
        Preconditions.checkNotNull(buffer, "buffer");
