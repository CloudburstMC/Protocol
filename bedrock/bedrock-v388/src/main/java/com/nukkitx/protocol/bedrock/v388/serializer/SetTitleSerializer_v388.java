...
public class SetTitleSerializer_v388 implements PacketSerializer<SetTitlePacket> {
    public static final SetTitleSerializer_v388 INSTANCE = new SetTitleSerializer_v388();
