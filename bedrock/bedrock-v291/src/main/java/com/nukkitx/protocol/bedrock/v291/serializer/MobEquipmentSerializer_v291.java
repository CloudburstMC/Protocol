...
public class MobEquipmentSerializer_v291 implements BedrockPacketSerializer<MobEquipmentPacket> {
    ...
    @Override
    public void serialize(ByteBuf buffer, BedrockPacketHelper helper, MobEquipmentPacket packet) {
    ...
    @Override
    public void deserialize(ByteBuf buffer, BedrockPacketHelper helper, MobEquipmentPacket packet) {
