...
public class AddPlayerSerializer_v291 implements PacketSerializer<AddPlayerPacket> {
    ...
    public void serialize(ByteBuf buffer, AddPlayerPacket packet) {
        ...
        AdventureSettingsSerializer_v291.INSTANCE.serialize(buffer, packet.getAdventureSettings());
