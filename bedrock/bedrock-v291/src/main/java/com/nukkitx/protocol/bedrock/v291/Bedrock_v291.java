...
public class Bedrock_v291 {
    public static BedrockPacketCodec V291_CODEC = BedrockPacketCodec.builder()
            ...
            .registerPacket(LevelSoundEventPacket.class, LevelSoundEventSerializer_v291.INSTANCE, 24)
            ...
            .registerPacket(FullChunkDataPacket.class, FullChunkDataSerializer_v291.INSTANCE, 58)
