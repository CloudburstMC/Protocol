...
public class PacketHeaderSerializer_v291 implements PacketSerializer<PacketHeader> {
    public static final PacketHeaderSerializer_v291 INSTANCE = new PacketHeaderSerializer_v291();
