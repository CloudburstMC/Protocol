...
public class StartGameSerializer_v527 extends StartGameSerializer_v440 {
    ...
    protected void writeLevelSettings(ByteBuf buffer, BedrockPacketHelper helper, StartGamePacket packet) {
        ...
        VarInts.writeUnsignedInt(buffer, packet.getDefaultPlayerPermission().ordinal());
    ...
    protected void readLevelSettings(ByteBuf buffer, BedrockPacketHelper helper, StartGamePacket packet) {
        ...
        packet.setDefaultPlayerPermission(PLAYER_PERMISSIONS[VarInts.readUnsignedInt(buffer)]);
