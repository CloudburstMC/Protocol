...
@UtilityClass
public class Bedrock_v560 {

    public static final BedrockPacketCodec V560_CODEC = Bedrock_v557.V557_CODEC.toBuilder()
        ...
        .registerPacket(UpdateClientInputLocksPacket.class, UpdateClientInputLocksSerializer_v560.INSTANCE, 169)
        .registerPacket(NpcDialoguePacket.class, NpcDialogueSerializer_v448.INSTANCE, 170)
        .registerPacket(EduUriResourcePacket.class, EduUriResourceSerializer_v465.INSTANCE, 171)
        .registerPacket(CreatePhotoPacket.class, CreatePhotoSerializer_v465.INSTANCE, 172)
        .registerPacket(UpdateSubChunkBlocksPacket.class, UpdateSubChunkBlocksSerializer_v465.INSTANCE, 173)
        .registerPacket(PhotoInfoRequestPacket.class, PhotoInfoRequestSerializer_v471.INSTANCE, 174)
        .registerPacket(SubChunkPacket.class, SubChunkSerializer_v486.INSTANCE, 175)
        .registerPacket(SubChunkRequestPacket.class, SubChunkRequestSerializer_v486.INSTANCE, 176)
        .registerPacket(PlayerStartItemCooldownPacket.class, PlayerStartItemCooldownSerializer_v486.INSTANCE, 177)
        .registerPacket(ScriptMessagePacket.class, ScriptMessageSerializer_v486.INSTANCE, 178)
        .registerPacket(CodeBuilderSourcePacket.class, CodeBuilderSourceSerializer_v486.INSTANCE, 179)
        .registerPacket(TickingAreasLoadStatusPacket.class, TickingAreasLoadStatusSerializer_v503.INSTANCE, 180)
        .registerPacket(DimensionDataPacket.class, DimensionDataSerializer_v503.INSTANCE, 181)
        .registerPacket(AgentActionEventPacket.class, AgentActionEventSerializer_v503.INSTANCE, 182)
        .registerPacket(ChangeMobPropertyPacket.class, ChangeMobPropertySerializer_v503.INSTANCE, 183)
        .registerPacket(LessonProgressPacket.class, LessonProgressSerializer_v527.INSTANCE, 184)
        .registerPacket(RequestAbilityPacket.class, RequestAbilitySerializer_v527.INSTANCE, 185)
        .registerPacket(RequestPermissionsPacket.class, RequestPermissionsSerializer_v527.INSTANCE, 186)
        .registerPacket(ToastRequestPacket.class, ToastRequestSerializer_v527.INSTANCE, 187)
        .registerPacket(UpdateAbilitiesPacket.class, UpdateAbilitiesSerializer_v534.INSTANCE, 188)
        .registerPacket(UpdateAdventureSettingsPacket.class, UpdateAdventureSettingsSerializer_v534.INSTANCE, 189)
        .registerPacket(DeathInfoPacket.class, DeathInfoSerializer_v534.INSTANCE, 190)
        .registerPacket(EditorNetworkPacket.class, EditorNetworkSerializer_v534.INSTANCE, 191)
        .registerPacket(FeatureRegistryPacket.class, FeatureRegistrySerializer_v544.INSTANCE, 192)
        .registerPacket(ServerStatsPacket.class, ServerStatsSerializer_v554.INSTANCE, 193)
        .registerPacket(RequestNetworkSettingsPacket.class, RequestNetworkSettingsSerializer_v554.INSTANCE, 194)
        .registerPacket(GameTestRequestPacket.class, GameTestRequestSerializer_v554.INSTANCE, 195)
        .registerPacket(GameTestResultsPacket.class, GameTestResultsSerializer_v554.INSTANCE, 196)
        .build();
}