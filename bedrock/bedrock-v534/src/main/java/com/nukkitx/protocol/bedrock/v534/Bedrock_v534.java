...
@UtilityClass
public class Bedrock_v534 {
    public static BedrockPacketCodec V534_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(534)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v534.INSTANCE, 11)
