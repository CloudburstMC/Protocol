...
public class PlayerActionSerializer_v526 implements BedrockPacketSerializer<PlayerActionPacket> {
    public static final PlayerActionSerializer_v526 INSTANCE = new PlayerActionSerializer_v526();
