...
public class ClientboundMapItemDataSerializer_v332 implements PacketSerializer<ClientboundMapItemDataPacket> {
    public static final ClientboundMapItemDataSerializer_v332 INSTANCE = new ClientboundMapItemDataSerializer_v332();
