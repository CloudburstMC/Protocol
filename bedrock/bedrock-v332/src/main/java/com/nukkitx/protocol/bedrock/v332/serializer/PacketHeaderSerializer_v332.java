...
public class PacketHeaderSerializer_v332 implements PacketSerializer<PacketHeader> {
    public static final PacketHeaderSerializer_v332 INSTANCE = new PacketHeaderSerializer_v332();
