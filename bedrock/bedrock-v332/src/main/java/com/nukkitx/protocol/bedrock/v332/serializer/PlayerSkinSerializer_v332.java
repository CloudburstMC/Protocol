...
public class PlayerSkinSerializer_v332 implements PacketSerializer<PlayerSkinPacket> {
    public static final PlayerSkinSerializer_v332 INSTANCE = new PlayerSkinSerializer_v332();
