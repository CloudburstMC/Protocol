...
public class NpcRequestSerializer_v332 implements PacketSerializer<NpcRequestPacket> {
    public static final NpcRequestSerializer_v332 INSTANCE = new NpcRequestSerializer_v332();
