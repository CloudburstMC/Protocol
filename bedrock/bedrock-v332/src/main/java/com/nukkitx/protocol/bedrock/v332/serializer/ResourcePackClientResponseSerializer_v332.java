...
public class ResourcePackClientResponseSerializer_v332 implements PacketSerializer<ResourcePackClientResponsePacket> {
    public static final ResourcePackClientResponseSerializer_v332 INSTANCE = new ResourcePackClientResponseSerializer_v332();
