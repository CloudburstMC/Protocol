...
public class BlockEntityDataSerializer_v332 implements PacketSerializer<BlockEntityDataPacket> {
    public static final BlockEntityDataSerializer_v332 INSTANCE = new BlockEntityDataSerializer_v332();
