...
public class CommandRequestSerializer_v332 implements PacketSerializer<CommandRequestPacket> {
    public static final CommandRequestSerializer_v332 INSTANCE = new CommandRequestSerializer_v332();
