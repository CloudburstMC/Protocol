...
public class SetEntityMotionSerializer_v332 implements PacketSerializer<SetEntityMotionPacket> {
    public static final SetEntityMotionSerializer_v332 INSTANCE = new SetEntityMotionSerializer_v332();
