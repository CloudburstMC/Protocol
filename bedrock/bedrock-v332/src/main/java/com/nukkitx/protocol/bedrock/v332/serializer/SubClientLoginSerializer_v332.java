...
public class SubClientLoginSerializer_v332 implements PacketSerializer<SubClientLoginPacket> {
    public static final SubClientLoginSerializer_v332 INSTANCE = new SubClientLoginSerializer_v332();
