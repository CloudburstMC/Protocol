...
public class PhotoTransferSerializer_v332 implements PacketSerializer<PhotoTransferPacket> {
    public static final PhotoTransferSerializer_v332 INSTANCE = new PhotoTransferSerializer_v332();
