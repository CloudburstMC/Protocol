...
public class CameraSerializer_v332 implements PacketSerializer<CameraPacket> {
    public static final CameraSerializer_v332 INSTANCE = new CameraSerializer_v332();
