...
public class MobEquipmentSerializer_v332 implements PacketSerializer<MobEquipmentPacket> {
    public static final MobEquipmentSerializer_v332 INSTANCE = new MobEquipmentSerializer_v332();
