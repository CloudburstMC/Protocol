...
public class SetSpawnPositionSerializer_v332 implements PacketSerializer<SetSpawnPositionPacket> {
    public static final SetSpawnPositionSerializer_v332 INSTANCE = new SetSpawnPositionSerializer_v332();
