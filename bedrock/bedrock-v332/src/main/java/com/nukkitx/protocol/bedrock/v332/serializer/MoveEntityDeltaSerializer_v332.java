...
public class MoveEntityDeltaSerializer_v332 implements PacketSerializer<MoveEntityDeltaPacket> {
    public static final MoveEntityDeltaSerializer_v332 INSTANCE = new MoveEntityDeltaSerializer_v332();
