...
public class SetPlayerGameTypeSerializer_v332 implements PacketSerializer<SetPlayerGameTypePacket> {
    public static final SetPlayerGameTypeSerializer_v332 INSTANCE = new SetPlayerGameTypeSerializer_v332();
