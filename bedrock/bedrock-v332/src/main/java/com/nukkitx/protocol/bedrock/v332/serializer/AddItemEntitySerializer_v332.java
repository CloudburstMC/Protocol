...
public class AddItemEntitySerializer_v332 implements PacketSerializer<AddItemEntityPacket> {
    public static final AddItemEntitySerializer_v332 INSTANCE = new AddItemEntitySerializer_v332();
