...
public class SetScoreboardIdentitySerializer_v332 implements PacketSerializer<SetScoreboardIdentityPacket> {
    public static final SetScoreboardIdentitySerializer_v332 INSTANCE = new SetScoreboardIdentitySerializer_v332();
