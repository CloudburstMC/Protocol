...
public class SetScoreSerializer_v332 implements PacketSerializer<SetScorePacket> {
    public static final SetScoreSerializer_v332 INSTANCE = new SetScoreSerializer_v332();
