...
import static com.nukkitx.protocol.bedrock.v332.serializer.LevelSoundEvent1Serializer_v332.SOUNDS;

@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class LevelSoundEvent2Serializer_v332 implements PacketSerializer<LevelSoundEvent2Packet> {
    public static final LevelSoundEvent2Serializer_v332 INSTANCE = new LevelSoundEvent2Serializer_v332();
