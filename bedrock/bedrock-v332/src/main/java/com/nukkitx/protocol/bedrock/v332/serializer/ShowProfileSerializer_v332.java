...
public class ShowProfileSerializer_v332 implements PacketSerializer<ShowProfilePacket> {
    public static final ShowProfileSerializer_v332 INSTANCE = new ShowProfileSerializer_v332();
