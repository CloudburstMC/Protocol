...
public class ResourcePackChunkDataSerializer_v332 implements PacketSerializer<ResourcePackChunkDataPacket> {
    public static final ResourcePackChunkDataSerializer_v332 INSTANCE = new ResourcePackChunkDataSerializer_v332();
