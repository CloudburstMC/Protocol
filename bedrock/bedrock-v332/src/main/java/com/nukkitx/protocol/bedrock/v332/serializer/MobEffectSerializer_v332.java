...
public class MobEffectSerializer_v332 implements PacketSerializer<MobEffectPacket> {
    public static final MobEffectSerializer_v332 INSTANCE = new MobEffectSerializer_v332();
