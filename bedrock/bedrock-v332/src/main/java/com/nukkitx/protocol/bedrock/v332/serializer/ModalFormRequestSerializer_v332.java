...
public class ModalFormRequestSerializer_v332 implements PacketSerializer<ModalFormRequestPacket> {
    public static final ModalFormRequestSerializer_v332 INSTANCE = new ModalFormRequestSerializer_v332();
