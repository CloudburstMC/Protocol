...
public class StructureBlockUpdateSerializer_v332 implements PacketSerializer<StructureBlockUpdatePacket> {
    public static final StructureBlockUpdateSerializer_v332 INSTANCE = new StructureBlockUpdateSerializer_v332();
