...
public class MoveEntityAbsoluteSerializer_v332 implements PacketSerializer<MoveEntityAbsolutePacket> {
    public static final MoveEntityAbsoluteSerializer_v332 INSTANCE = new MoveEntityAbsoluteSerializer_v332();
