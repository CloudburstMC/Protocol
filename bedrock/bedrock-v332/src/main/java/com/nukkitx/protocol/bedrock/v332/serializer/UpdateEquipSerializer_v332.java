...
public class UpdateEquipSerializer_v332 implements PacketSerializer<UpdateEquipPacket> {
    public static final UpdateEquipSerializer_v332 INSTANCE = new UpdateEquipSerializer_v332();
