...
public class ContainerOpenSerializer_v332 implements PacketSerializer<ContainerOpenPacket> {
    public static final ContainerOpenSerializer_v332 INSTANCE = new ContainerOpenSerializer_v332();
