...
public class HurtArmorSerializer_v332 implements PacketSerializer<HurtArmorPacket> {
    public static final HurtArmorSerializer_v332 INSTANCE = new HurtArmorSerializer_v332();
