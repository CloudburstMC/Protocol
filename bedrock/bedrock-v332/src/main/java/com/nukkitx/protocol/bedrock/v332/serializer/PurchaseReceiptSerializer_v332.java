...
public class PurchaseReceiptSerializer_v332 implements PacketSerializer<PurchaseReceiptPacket> {
    public static final PurchaseReceiptSerializer_v332 INSTANCE = new PurchaseReceiptSerializer_v332();
