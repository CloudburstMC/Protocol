...
public class UpdateBlockSyncedSerializer_v332 implements PacketSerializer<UpdateBlockSyncedPacket> {
    public static final UpdateBlockSyncedSerializer_v332 INSTANCE = new UpdateBlockSyncedSerializer_v332();
