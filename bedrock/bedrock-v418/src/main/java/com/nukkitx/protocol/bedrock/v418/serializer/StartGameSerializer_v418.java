...
public class StartGameSerializer_v418 implements BedrockPacketSerializer<StartGamePacket> {

    public static final StartGameSerializer_v418 INSTANCE = new StartGameSerializer_v418();
