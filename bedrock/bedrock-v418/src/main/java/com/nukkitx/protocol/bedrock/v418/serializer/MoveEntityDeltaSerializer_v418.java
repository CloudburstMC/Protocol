...
public class MoveEntityDeltaSerializer_v418 extends MoveEntityDeltaSerializer_v388 {
    ...
    public static final MoveEntityDeltaSerializer_v418 INSTANCE = new MoveEntityDeltaSerializer_v418();

    protected MoveEntityDeltaSerializer_v418() {
        super();
